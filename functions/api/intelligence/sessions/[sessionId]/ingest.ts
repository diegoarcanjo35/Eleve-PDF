import { MAX_INGEST_BODY_BYTES, CHUNKING_STRATEGY_VERSION } from "../../../../../shared/intelligence/constants";
...
export const onRequestPost: PagesFunction<Env> = async (context) => {
  ...
  try {
    ...
    // Falha de chunking/persistência nunca deixa a sessão falsamente
    // `ready` — transição para o estado terminal `failed`.
